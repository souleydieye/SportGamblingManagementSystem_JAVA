...
public class PersonTest {
	...
	public void beforeTests() throws ParseException, BadParametersException{
		...
		this.competitor=new Person("Rochd","Maliki", new Date(cal.getTimeInMillis()));
	}
	...
	public void testEqualsObjects() throws BadParametersException {
		//same 
		this.cal.set(1995,Calendar.DECEMBER, 24);
		Person competitor1=new Person("Rochd", "Maliki", new Date(this.cal.getTimeInMillis()));
		assertTrue(this.competitor.equals(competitor1));
		// diferent born date
		this.cal.set(1994, Calendar.DECEMBER, 24);
		Person competitor2=new Person("Rochd","Maliki",new Date(this.cal.getTimeInMillis()));
		assertFalse(this.competitor.equals(competitor2));
		//diferent first name
		Person competitor3 = new Person("Lqred","Maliki",new Date(this.cal.getTimeInMillis()));
		assertFalse(this.competitor.equals(competitor3));
		//diferent last name
		Person competitor4 = new Person("Rochd","Diali",new Date(this.cal.getTimeInMillis()));
